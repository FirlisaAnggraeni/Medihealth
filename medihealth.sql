...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2020 at 12:25 AM
...
INSERT INTO `cart_transaction` (`transaction_id`, `cart_id`) VALUES
(4, 10);
...
INSERT INTO `product` (`id`, `name`, `description`, `banner`, `price`, `stock`) VALUES
(17, 'superman', 'What is Lorem Ipsum?\r\nLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', 'banner/17.gif', 2500000, 5);
...
(2, 6, 17, 'What is Lorem Ipsum? Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting,');
...
INSERT INTO `user` (`id`, `name`, `email`, `phone`, `address`, `username`, `password`, `is_admin`) VALUES
(6, 'admin', 'admin@admin', '+629', 'admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1);
...
--
ALTER TABLE `cart_transaction`
  ADD CONSTRAINT `cart_transaction_ibfk_1` FOREIGN KEY (`transaction_id`) REFERENCES `transaction` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `cart_transaction_ibfk_2` FOREIGN KEY (`cart_id`) REFERENCES `cart` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
